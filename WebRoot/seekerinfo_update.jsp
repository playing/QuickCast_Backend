...
function  update_seekerinfo(){
 var ajax_data = $("#update_seekerinfo").serialize();
 alert(ajax_data);
 $.ajax({
        type: "post",
        url: "seekerinfo.do?method=seekerinfo_update",
        data: ajax_data,
...
<body>
      <form id = "update_seekerinfo">
        ...
        seeker_photo:<input type=text name="seeker_photo"/><br/>
          ...
          <button type = button onclick = "update_seekerinfo()" >更改个人信息</button>
      </form>
</body>
</html>