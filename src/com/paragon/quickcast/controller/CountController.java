...
public class CountController {
	...
	public @ResponseBody String imp_count_queryByCountRsmhandleEtpId(){
		...
		List mseeker = countservice.queryBySeekerGender("男");
		List fseeker = countservice.queryBySeekerGender("女");
		List mhunter = countservice.queryByHunterGender("男");
		List fhunter = countservice.queryByHunterGender("女");
		List metp = countservice.queryByEtpGender("男");
		List fetp = countservice.queryByEtpGender("女");
		Map data = new HashMap();
		JSONArray json_result = new JSONArray();
