...
public class Rsm_DeliverController {
	...
	public @ResponseBody String imp_deliver_insert(@RequestBody Rsm_Deliver rsm_deliver){
		...
		System.out.println("Õ∂µ›±‡∫≈£∫--------"+rsm_deliver.getDeliver_id());
		System.out.println("ºÚ¿˙±‡∫≈£∫--------"+rsm_deliver.getRsm_id());
		System.out.println("∆Û“µ±‡∫≈£∫--------"+rsm_deliver.getEtp_id());
		System.out.println("¡‘Õ∑±‡∫≈£∫--------"+rsm_deliver.getHunter_id());
